...
<div class="bg-white rounded-lg shadow-md mb-5">
    <div class="p-4">
        <form method="POST" action="{{ route('autoloader.approve', $check->hashid) }}" id="approveForm">
            @csrf
            ...
            <div class="bg-sky-50 p-4 rounded-md mb-5">
                ...
                <span class="font-bold text-blue-700">
                    @php
                        ...
                        $checkers = $results->pluck('checker_username')->filter()->unique()->implode(', ');
                    @endphp
            ...
            <div class="flex justify-between mt-6">
                ...
                <div class="flex flex-row flex-wrap gap-2 justify-end">
                    ...
                    @else
                        <!-- PDF Preview Button -->
                        <a href="{{ route('autoloader.pdf', $check->hashid) }}" target="_blank" class="flex items-center justify-center text-xs sm:text-sm md:text-base px-3 sm:px-4 md:px-5 py-1.5 sm:py-2 md:py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition duration-300 ease-in-out">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 sm:h-5 sm:w-5 mr-1 sm:mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <!-- Download PDF Button -->
                        <a href="{{ route('autoloader.downloadPdf', $check->hashid) }}" class="flex items-center justify-center text-xs sm:text-sm md:text-base px-3 sm:px-4 md:px-5 py-1.5 sm:py-2 md:py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition duration-300 ease-in-out">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 sm:h-5 sm:w-5 mr-1 sm:mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
