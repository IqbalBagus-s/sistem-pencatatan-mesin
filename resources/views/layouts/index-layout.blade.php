...
<body class="bg-blue-50 pt-5 font-poppins min-h-screen flex flex-col overscroll-none">
    ...
    <div id="notification-popup" class="fixed top-5 left-1/2 transform -translate-x-1/2 z-50 hidden">
        ...
        <div id="success-notification" class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded shadow-md flex items-center w-full hidden">
        ...
        <div id="error-notification" class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded shadow-md flex items-center w-full hidden">
            <div class="mr-2 flex-shrink-0">
        ...
        <div id="warning-notification" class="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded shadow-md flex items-center w-full hidden">
            <div class="mr-2 flex-shrink-0">
