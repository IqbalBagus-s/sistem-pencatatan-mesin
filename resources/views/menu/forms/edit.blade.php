...
<div class="bg-white rounded-lg shadow-sm p-6 max-w-md mx-auto">
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-xl font-bold text-gray-800">Edit Form</h1>
    </div>
    ...
    <form action="{{ route('host.forms.update', $form->id) }}" method="POST" autocomplete="off">
        @csrf
        @method('PUT')
        ...
        <div class="mb-5">
            ...
            <input type="text" id="nomor_form" name="nomor_form" 
                ...
                value="{{ old('nomor_form', $form->nomor_form) }}" 
        ...
        <div class="mb-5">
            ...
            <input type="date" id="tanggal_efektif" name="tanggal_efektif" 
                ...
                value="{{ old('tanggal_efektif', $form->tanggal_efektif ? date('Y-m-d', strtotime($form->tanggal_efektif)) : '') }}"
                required>
