        ...
        <div class="mb-5">
            ...
            <div class="relative">
                <select id="role" name="role" 
                    class="w-full px-3 py-2 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 appearance-none @error('role') @enderror" 
                    required>
