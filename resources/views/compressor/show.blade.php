...
<div class="bg-white rounded-lg shadow-md mb-5">
    <div class="p-4">
        ...
        <form action="{{ route('compressor.approve', $check->hashid) }}" method="POST" id="approvalForm"
            x-data="{
            ...
            <div class="mt-8 bg-white rounded-lg p-2 sm:p-4">
                <div class="flex flex-row flex-wrap items-center justify-between gap-2">
                    ...
                    <div class="flex flex-row flex-wrap gap-2 justify-end">
                        ...
                        @if (!empty($check->approver_shift1_id) && !empty($check->approver_shift2_id))
                            <!-- PDF Preview Button -->
                            <a href="{{ route('compressor.pdf', $check->hashid) }}" target="_blank" class="flex items-center justify-center text-xs sm:text-sm md:text-base px-3 sm:px-4 md:px-5 py-1.5 sm:py-2 md:py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition duration-300 ease-in-out">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 sm:h-5 sm:w-5 mr-1 sm:mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <!-- Download PDF Button -->
                            <a href="{{ route('compressor.downloadPdf', $check->hashid) }}" class="flex items-center justify-center text-xs sm:text-sm md:text-base px-3 sm:px-4 md:px-5 py-1.5 sm:py-2 md:py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition duration-300 ease-in-out">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 sm:h-5 sm:w-5 mr-1 sm:mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
