        ...
        <table class="w-full border-collapse border border-gray-300">
            ...
            <tbody class="bg-white">
                <tr class="bg-sky-50">
                    ...
                    <!-- Week 1 - Solusi: Input selalu ada tapi dengan visibility hidden alih-alih hidden class -->
                    ...
                    <!-- Week 2 - Dengan solusi yang sama -->
                    <td colspan="2" class="border border-gray-300 p-1 bg-sky-50">
                    ...
                    <!-- Week 3 - Dengan solusi yang sama -->
                    <td colspan="2" class="border border-gray-300 p-1 bg-sky-50">
                    ...
                    <!-- Week 4 - Dengan solusi yang sama -->
                    <td colspan="2" class="border border-gray-300 p-1 bg-sky-50">
