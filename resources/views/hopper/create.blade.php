...
<div class="bg-white rounded-lg shadow-md mb-5">
    <div class="p-4">
        ...
        <form action="{{ route('hopper.store') }}" method="POST" autocomplete="off">
            @csrf
            <!-- Form Grid - Responsive untuk Mobile/Tablet -->
            ...
            <!-- Tabel Inspeksi - dengan scroll horizontal pada mobile/tablet -->
                    ...
                    <table class="w-full border-collapse border border-gray-300">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="border border-gray-300 bg-sky-50 p-2 text-sm min-w-20">Check</th>
                                <th class="border border-gray-300 bg-sky-50 p-2 text-sm min-w-20">Check</th>
                                <th class="border border-gray-300 bg-sky-50 p-2 text-sm min-w-20">Check</th>
                                <th class="border border-gray-300 bg-sky-50 p-2 text-sm min-w-20">Check</th>
                            </tr>
                        ...
                        <tbody>
                            ...
                            @foreach($items as $i => $item)
                                <tr>
                                    ...
                                    <td class="border border-gray-300 p-2 h-12 text-xs min-w-28">
                                    ...
                                    <td class="border border-gray-300 p-2 h-12 text-xs min-w-24">
                                    ...
                                    <td class="border border-gray-300 p-2 h-12 text-xs min-w-32">
            ...
            <!-- Tombol Submit yang lebih besar untuk mobile -->
            <div class="mt-6">
