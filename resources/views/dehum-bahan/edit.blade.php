            ...
            <tbody class="bg-white">
                <tr class="bg-sky-50">
                    ...
                    <td colspan="2" class="border border-gray-300 p-2 bg-sky-50">
                        <div x-data="{ selected: '{{ $dehumCheck->checked_by_minggu1 }}' ? true : false, userName: '{{ $dehumCheck->checked_by_minggu1 }}' }">
                            <button type="button" 
                            ...
                            <div class="mt-2 space-y-1" x-show="selected">
                                <input type="text" name="created_by_1" x-ref="user1" x-bind:value="userName || '{{ $dehumCheck->checked_by_minggu1 }}'"
                                    class="w-full px-2 py-1 text-sm bg-gray-100 border border-gray-300 rounded"
                                    readonly>
                                <input type="text" name="created_date_1" x-ref="date1" 
                                    value="{{ $dehumCheck->tanggal_minggu1 }}"
                                    class="w-full px-2 py-1 text-sm bg-gray-100 border border-gray-300 rounded"
                                    readonly>
                            </div>
                        </div>
                    ...
                    <!-- Week 2 -->
                    <td colspan="2" class="border border-gray-300 p-2 bg-sky-50">
                        <div x-data="{ selected: '{{ $dehumCheck->checked_by_minggu2 }}' ? true : false, userName: '{{ $dehumCheck->checked_by_minggu2 }}' }">
                            <button type="button" 
                                @click="selected = !selected; 
                                    if(selected) {
                                        userName = '{{ Auth::user()->username }}'; 
                            ...
                            <div class="mt-2 space-y-1" x-show="selected">
                                <input type="text" name="created_by_2" x-ref="user2" x-bind:value="userName || '{{ $dehumCheck->checked_by_minggu2 }}'"
                                    class="w-full px-2 py-1 text-sm bg-gray-100 border border-gray-300 rounded"
                                    readonly>
                                <input type="text" name="created_date_2" x-ref="date2" 
                                    value="{{ $dehumCheck->tanggal_minggu2 }}"
                                    class="w-full px-2 py-1 text-sm bg-gray-100 border border-gray-300 rounded"
                                    readonly>
                            </div>
                        </div>
                    ...
                    <!-- Week 3 -->
                    <td colspan="2" class="border border-gray-300 p-2 bg-sky-50">
                        <div x-data="{ selected: '{{ $dehumCheck->checked_by_minggu3 }}' ? true : false, userName: '{{ $dehumCheck->checked_by_minggu3 }}' }">
                            <button type="button" 
                                @click="selected = !selected; 
                                    if(selected) {
                                        userName = '{{ Auth::user()->username }}'; 
                            ...
                            <div class="mt-2 space-y-1" x-show="selected">
                                <input type="text" name="created_by_3" x-ref="user3" x-bind:value="userName || '{{ $dehumCheck->checked_by_minggu3 }}'"
                                    class="w-full px-2 py-1 text-sm bg-gray-100 border border-gray-300 rounded"
                                    readonly>
                                <input type="text" name="created_date_3" x-ref="date3" 
                                    value="{{ $dehumCheck->tanggal_minggu3 }}"
                                    class="w-full px-2 py-1 text-sm bg-gray-100 border border-gray-300 rounded"
                                    readonly>
                            </div>
                        </div>
                    ...
                    <!-- Week 4 -->
                    <td colspan="2" class="border border-gray-300 p-2 bg-sky-50">
                        <div x-data="{ selected: '{{ $dehumCheck->checked_by_minggu4 }}' ? true : false, userName: '{{ $dehumCheck->checked_by_minggu4 }}' }">
                            <button type="button" 
                                @click="selected = !selected; 
                                    if(selected) {
                                        userName = '{{ Auth::user()->username }}'; 
                            ...
                            <div class="mt-2 space-y-1" x-show="selected">
                                <input type="text" name="created_by_4" x-ref="user4" x-bind:value="userName || '{{ $dehumCheck->checked_by_minggu4 }}'"
                                    class="w-full px-2 py-1 text-sm bg-gray-100 border border-gray-300 rounded"
                                    readonly>
                                <input type="text" name="created_date_4" x-ref="date4" 
                                    value="{{ $dehumCheck->tanggal_minggu4 }}"
                                    class="w-full px-2 py-1 text-sm bg-gray-100 border border-gray-300 rounded"
                                    readonly>
                            </div>
                        </div>
