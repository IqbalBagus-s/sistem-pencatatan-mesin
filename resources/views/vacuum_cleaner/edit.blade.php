    ...
    <div class="p-4">
        ...
        <form action="{{ route('vacuum-cleaner.update', $check->id) }}" method="POST" autocomplete="off">
            ...
            <div class="flex items-center justify-between mt-8">
                <a href="{{ route('vacuum-cleaner.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition duration-150 ease-in-out">
                ...
                <div class="flex gap-2">
                    <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition duration-150 ease-in-out flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
