...
<body class="flex items-center justify-center min-h-screen bg-green-50 px-4 py-6">
    ...
    <div class="login-container w-full">
        <div class="p-4 md:p-6 bg-white rounded-lg shadow-md">
            ...
            <h2 class="text-center text-gray-600 text-xl sm:text-2xl mb-4 md:mb-6">Login Admin</h2>

            <!-- PERUBAHAN DISINI: Mengubah action ke route admin.login.post -->
            <form action="{{ route('admin.login.post') }}" method="POST" id="loginForm" autocomplete="off">
                @csrf
                <div class="mb-4">
                ...
                <!-- Tambahkan div untuk menampilkan error secara eksplisit jika ada -->
                @if(session('error'))
