<!-- resources/views/air-dryer/create.blade.php -->
...
<div class="bg-white rounded-lg shadow-md mb-5">
    <div class="p-4">
        ...
        <!-- Form Input -->
        <form action="{{ route('air-dryer.store') }}" method="POST" autocomplete="off">
            @csrf
                        ...
                        <tbody>
                            @for ($i = 1; $i <= 8; $i++)
                                <tr>
                                    ...
                                    <td class="border border-gray-300 p-2">
                                        <input type="text" name="temperatur_angin_in[{{ $i }}]" class="w-full px-2 py-1 text-sm bg-white border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-blue-500 focus:bg-white" placeholder="30°C - 60°C">
                                    </td>
                                    <td class="border border-gray-300 p-2">
                                        <input type="text" name="temperatur_angin_out[{{ $i }}]" class="w-full px-2 py-1 text-sm bg-white border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-blue-500 focus:bg-white" placeholder="30°C - 60°C">
                                    </td>
                                    <td class="border border-gray-300 p-2">
            ...
            @include('components.create-form-buttons', ['backRoute' => route('air-dryer.index')])
