...
@section('content')
<!-- Error Notification -->
<div id="error-notification" class="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 {{ session('error') ? '' : 'hidden' }}">
    <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded shadow-md flex items-center max-w-md">
        ...
        <p class="mr-6 text-sm" id="error-message">{{ session('error') }}</p>
