...
return new class extends Migration
{
    ...
    {
        Schema::create('dehum_bahan_checks', function (Blueprint $table) {
            $table->id();
            $table->string('nomer_dehum_bahan'); // Menyimpan nomor dehum bahan
    ...
    {
        Schema::dropIfExists('dehum_bahan_checks');
    }
};
